# -*- coding: utf-8 -*-
#
# Cassowary documentation build configuration file, created by
...
version = '.'.join(str(n) for n in cassowary.NUM_VERSION[:2])
# The full version, including alpha/beta/rc tags.
release = cassowary.VERSION
...
htmlhelp_basename = 'cassowarydoc'
